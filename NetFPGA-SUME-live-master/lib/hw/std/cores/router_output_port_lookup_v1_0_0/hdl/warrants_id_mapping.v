...
*******************************************************************************/
  ...
  module warrants_id_mapping
   ...
   (
    ...
    //output [199:0] order_index_out,
    output [201:0] order_index_out,
...
//   reg  [199:0] order_index_in;
   reg	[201:0] order_index_in;
   ...
   reg  [198:0]	order_content_in;
   wire [198:0]	order_content_out;
...
//   wire [199:0]  order_content;
   wire [201:0] order_content;
   ...
   //-------------------------------------
   //fallthrough_small_fifo #(.WIDTH(200), .MAX_DEPTH_BITS(10)) // 16
     fallthrough_small_fifo #(.WIDTH(202), .MAX_DEPTH_BITS(12))
      order_output_fifo
		    ...
		    if(current_owner_reg == 3'd4 && !in_fifo_nearly_full) begin
			   ...
			   if(order_match_ack) begin
				...
				order_index_in = order_content;
                           	...
                           	in_fifo_wr                    =  (order_content[2:0] != 3'd0)? 'b1: 'b0;
